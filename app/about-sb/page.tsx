      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-8">
          <div className="glass-card p-8 flex-1 flex flex-col items-center">
            <svg className="w-10 h-10 text-blue-700 mb-2" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="8" r="4" /><path d="M6 20v-2a4 4 0 014-4h0a4 4 0 014 4v2" /></svg>
            <h2 className="text-2xl font-semibold text-blue-700 mb-2">Active members</h2>
            <p className="text-white text-3xl font-bold">30+</p>
          </div>
          <div className="glass-card p-8 flex-1 flex flex-col items-center">
            <svg className="w-10 h-10 text-green-600 mb-2" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2" /><path d="M16 2v4M8 2v4M3 10h18" /></svg>
