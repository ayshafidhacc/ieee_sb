			...
			<div className="container mx-auto px-6">
								...
								<div className="space-y-8">
									...
									<div className="glass-card p-6">
										<h2 className="text-xl font-bold text-blue-700 mb-2">Workshop on UI/UX</h2>
									...
									<div className="glass-card p-6">
										<h2 className="text-xl font-bold text-blue-700 mb-2">Design Pulse - Poster Designing Competition</h2>
									...
									<div className="glass-card p-6">
										<h2 className="text-xl font-bold text-blue-700 mb-2">Workshop on Product Design</h2>
									...
									<div className="glass-card p-6">
										<h2 className="text-xl font-bold text-blue-700 mb-2">Expert Talk: Addressing Research Challenges in AI for Smart IoT Applications</h2>
									...
									<div className="glass-card p-6">
										<h2 className="text-xl font-bold text-blue-700 mb-2">Online Workshop: Fundamentals of Blockchain and its Future Applications</h2>
								...
								<div className="space-y-8">
									{/* Flutter Workshop */}
									<div className="glass-card p-6">
										<h2 className="text-xl font-bold text-blue-700 mb-2">Workshop on Flutter</h2>
									...
									{/* Execom Selection */}
									<div className="glass-card p-6">
										<h2 className="text-xl font-bold text-blue-700 mb-2">Execom Selection</h2>
									...
									{/* Execom Training (Nov) */}
									<div className="glass-card p-6">
										<h2 className="text-xl font-bold text-blue-700 mb-2">Execom Training</h2>
									...
									<div className="glass-card p-6">
										<h2 className="text-xl font-bold text-blue-700 mb-2">Inauguration of IEEE Student Branch</h2>
									...
									<div className="glass-card p-6">
										<h2 className="text-xl font-bold text-blue-700 mb-2">Technical Talk on IEEE Standards</h2>
										<p className="text-white mb-1"><span className="font-semibold">Date:</span> 07 December 2023 | <span className="font-semibold">Venue:</span> Seminar Hall 1 | <span className="font-semibold">Participants:</span> 100</p>
									...
									<div className="glass-card p-6">
										<h2 className="text-xl font-bold text-blue-700 mb-2">Trivia - Technical Quiz</h2>
									...
									<div className="glass-card p-6">
										<h2 className="text-xl font-bold text-blue-700 mb-2">Technical Talk: Path to Internationalisation</h2>
									...
									<div className="glass-card p-6">
										<h2 className="text-xl font-bold text-blue-700 mb-2">Workshop: Design and Commissioning of Solar Power Plants (Part 1)</h2>
									...
									<div className="glass-card p-6">
										<h2 className="text-xl font-bold text-blue-700 mb-2">Workshop: Design and Commissioning of Solar Power Plants (Part 2)</h2>
