	...
	return (
		<section className="w-full min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100">
			<div className="container mx-auto px-6 py-16 flex flex-col items-center">
				<img  src="/ieee_sb/SB Logo.png" alt="IEEE Student Branch Logo" className="h-24 mb-6" />
				...
				<Link href="/membership" className="bg-blue-700 text-white font-semibold px-6 py-3 rounded-lg shadow hover:bg-blue-800 transition mb-10">Become a Member</Link>
